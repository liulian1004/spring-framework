...
public class CartItemController {
	...
	@ResponseStatus(value = HttpStatus.CREATED)// 返回是否成功
	...
	@ResponseStatus(value = HttpStatus.NO_CONTENT)// 不需要返回任何内容
	...
	public void removeAllItem(@PathVariable(value ="cartId") int cartId) {
